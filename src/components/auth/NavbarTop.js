    ...
    render() {
        return(
            <Navbar expand="sm" fixed="top" style={{backgroundColor:'#008fc373'}}>
                <Container>
                    <Navbar.Brand href='/TL-SampleServicesPayment/services'>
                    ...
                    <Navbar.Offcanvas id="offcanvasNavbar-expand" placement="end" style={{backgroundColor:'#008fc3',width:'30vh'}} >
                        ...
                        <Offcanvas.Body>
                            <Nav className='me-auto NavbarTop'>
                                <Nav.Link style={{color: 'whitesmoke'}} href='/TL-SampleServicesPayment/about'>About</Nav.Link>
                                <Nav.Link style={{color: 'whitesmoke'}} href='/TL-SampleServicesPayment/services'>Services</Nav.Link>
                            </Nav>
                        </Offcanvas.Body>
                    </Navbar.Offcanvas>
